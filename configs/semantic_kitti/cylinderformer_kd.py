...
hooks = [
    dict(type="KDCheckpointLoader"),
    dict(type="KDModelHook"),
    dict(type="IterationTimer", warmup_iter=2),
    dict(type="InformationWriter"),
    dict(type="KDSemSegEvaluator"),
    dict(type="KDCheckpointSaver", save_freq=None),
    dict(type="KDPreciseEvaluator", test_last=False),
]


train = dict(type="KDTrainer")
alpha1 = 0.05
alpha2 = 1
alpha3 = 1
tau = 3.0
...
test = dict(type="KDSemSegGlobalTester", verbose=True)

teacher_weight = "/model/model_best.pth"


teacher_model = dict(
    type="KDSegmentorGlobalTeacher",
    num_classes=19,
