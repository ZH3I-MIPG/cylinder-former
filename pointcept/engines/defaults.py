...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        "--config-file", default="../configs/semantic_kitti/semseg-pt-v3m1-0-base.py", metavar="FILE", help="path to config file"
    )
    parser.add_argument(
...
def default_config_parser(file_path, options):
    ...
    if os.path.isfile(file_path):
        ...
        sep = file_path.find("-")
        # cfg = Config.fromfile(os.path.join(file_path[:sep], file_path[sep + 1:]))  JK
        cfg = Config.fromfile(file_path)
